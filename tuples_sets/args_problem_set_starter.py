...
print(contains_pickle(5, 4))
#  contains_pickle("red", 45, "pickle", [])  --> True
def contains_pickle2(*args):
    main_list = "red", 45, "pickle", []
    return any(element in main_list for element in args)


print(contains_pickle2(3, 4, 'red'))
#  contains_pickle(1,2, "blue") ---------------> False

def contains_pickle3(*args):
    main_list = 1,2, "blue"
    return any(element in main_list for element in args)
    
print(contains_pickle3(1,2, "blue"))
